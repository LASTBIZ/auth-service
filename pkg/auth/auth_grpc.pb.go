...
type AuthServiceClient interface {
	...
	CheckRegister(ctx context.Context, in *CheckRegisterRequest, opts ...grpc.CallOption) (*CheckRegisterResponse, error)
...
func (c *authServiceClient) LoginByPassword(ctx context.Context, in *LoginByPasswordRequest, opts ...grpc.CallOption) (*LoginResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/auth.AuthService/LoginByPassword", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) CheckRegister(ctx context.Context, in *CheckRegisterRequest, opts ...grpc.CallOption) (*CheckRegisterResponse, error) {
	out := new(CheckRegisterResponse)
	err := c.cc.Invoke(ctx, "/auth.AuthService/CheckRegister", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServiceServer interface {
	...
	CheckRegister(context.Context, *CheckRegisterRequest) (*CheckRegisterResponse, error)
...
func (UnimplementedAuthServiceServer) CheckRegister(context.Context, *CheckRegisterRequest) (*CheckRegisterResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CheckRegister not implemented")
}
...
func _AuthService_LoginByPassword_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/auth.AuthService/LoginByPassword",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AuthService_CheckRegister_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CheckRegisterRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).CheckRegister(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/auth.AuthService/CheckRegister",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).CheckRegister(ctx, req.(*CheckRegisterRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AuthService_CheckRegister_Handler,
		},
		{
